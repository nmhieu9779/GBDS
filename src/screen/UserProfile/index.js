...
import {resetUserProfile, resetUriAvatar, resetSignIn, changePassword, showToast} from "@src/redux/actions"
...
const mapStateToProps = (state) => {
  const userProfile = state.userProfile.userProfile.success
    ...
    : {}
  return {
    uriAvatar: userProfile.avatarImageUrl,
...
const mapDispatchToProps = (dispatch) => {
  let actionCreators = {resetUserProfile, resetUriAvatar, resetSignIn, changePassword, showToast}
